...
public class TestOrderPageFireFox {
    ...
    public TestOrderPageFireFox(String name, String surname, String address, String metroStation, String phoneNumber) {
    ...
    public static Object[][] getTestData() {
        return new Object[][]{{"Иван", "Тюлькин", "Москва, 13-я Парковая, 27, к. 4, кв. 38", "Щёлковская", "+79991634436"}};
    }
